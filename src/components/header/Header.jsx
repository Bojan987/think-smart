...
import { logedIn, logOut } from "../../actions/loginAction";
        ...
        <Container>
          ...
          <Navbar.Collapse id="basic-navbar-nav">
            ...
            <Nav className="ml-auto">
             ...
             { !isLogedin.logedin? <><Nav.Link ref={target} onClick={() => setShow(!show)}>
              ...
              </Overlay></>:<Nav.Link ref={target} onClick={() => dispatch(logOut())}>
              ...
              {isLogedin.logedin && <LinkContainer to='/mymeals'>
